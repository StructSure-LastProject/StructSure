...
const AdminPanelBottom = () => {
  return (
    <>
        <div class="max-w-[1250px] w-full h-auto rounded-[20px] pt-[25px] pl-[20px] gap-[10px] mx-auto">
            <h1 class="text-2xl sm:text-3xl font-poppins title">Logs</h1>
        </div>
        <div class="flex flex-col mt-[2%] pl-[20px] max-w-[1250px] w-full h-auto gap-[10px] mx-auto">
