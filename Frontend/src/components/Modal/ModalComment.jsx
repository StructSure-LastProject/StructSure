...
const ModalComment = ({note, onInput}) => {
  return (
    <div class="flex flex-col gap-[5px]">
      ...
      <textarea class="rounded-[10px] w-full px-[16px] py-[8px] flex gap-[10px] bg-lightgray normal [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
                value={note}
                maxlength={1000}
                onInput={onInput}
      >
