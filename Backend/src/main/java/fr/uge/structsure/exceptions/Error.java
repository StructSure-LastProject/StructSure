...
public enum Error {
    ...
    SUPER_ADMIN_ACCOUNT_PASSWORD_CANT_BE_MODIFIED(422, "Le mot de passe d’un compte super-administrateur ne peut pas être modifié"),
    ADMIN_ACCOUNT_CANT_BE_MODIFIED_BY_AN_ADMIN_ACCOUNT(422, "Le rôle d’un compte administrateur ne peut pas être modifié"),
    ADMIN_ACCOUNT_PASSWORD_CANT_BE_MODIFIED_BY_AN_ADMIN_ACCOUNT(422, "Le mot de passe d’un compte administrateur ne peut pas être modifié"),
    ...
    SENSOR_NOTE_EXCEED_LIMIT(422, "La note dépasse le nombre de caractères (0-1000 caractères)"),
