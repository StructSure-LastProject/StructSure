...
import fr.uge.structsure.dto.userAccount.accountStructure.ErrorUpdateUserStructureAccessResponseDTO;
import fr.uge.structsure.dto.userAccount.accountStructure.IUpdateUserStructureAccessResponseDTO;
...
public class AccountService {
     ...
     */
    public IUpdateUserStructureAccessResponseDTO updateUserStructureAccess(String login, UserStructureAccessRequestDTO userStructureAccessRequestDTO) throws TraitementException{
        ...
        if (!unChangedAccess.isEmpty()){
            return new ErrorUpdateUserStructureAccessResponseDTO("Ouvrage introuvable", Collections.unmodifiableList(changedAccess), Collections.unmodifiableList(unChangedAccess));
        }
        return new UpdateUserStructureAccessResponseDTO(login, Collections.unmodifiableList(changedAccess));
    }
